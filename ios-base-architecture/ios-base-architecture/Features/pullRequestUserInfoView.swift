...
class PullRequestUserInfoView: UIView {
    ...
    func setupViews(){
        ...
        avatarImageView.anchor(top: topAnchor, leading: leadingAnchor, bottom: nil, trailing: nil, padding: UIEdgeInsets(top: 12, left: 18, bottom: 0, right: 0), size: CGSize(width: 22, height: 22))
        ...
        let titleLabelsStackView = UIStackView(arrangedSubviews: [userLoginLabel, dateLabel, UIView()])
        titleLabelsStackView.axis = .vertical
        titleLabelsStackView.spacing = 2
        
        addSubview(titleLabelsStackView)
        titleLabelsStackView.anchor(top: avatarImageView.topAnchor, leading: avatarImageView.trailingAnchor, bottom: nil, trailing: trailingAnchor, padding: UIEdgeInsets(top: 0, left: 10, bottom: 0, right: 14))
        
        descriptionLabel.anchor(top: avatarImageView.bottomAnchor, leading: avatarImageView.leadingAnchor, bottom: nil, trailing: trailingAnchor, padding: UIEdgeInsets(top: 25, left: 0, bottom: 0, right: 20))
    }
    
    func set(){
        dateLabel.text = "02/20/2019"
        userLoginLabel.text = "cheshire137"
